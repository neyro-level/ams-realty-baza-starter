...
| public | `src/server/public-gateway/**`, `publicGatewayReadAccess` | system public-read whitelist |
| ingest | `src/core/ingest/payload-feed-ingest-repository.ts` | system-job |
| system | `src/payload/jobs/tasks.ts`, `src/server/system-gateway/**`, `src/core/data-access/system/**` | systemOverrideAccess whitelist |
